...
/**
 * AccountRecordTbl generated by hbm2java
 */
@Entity
@Table(name = "account_record_tbl", catalog = "intimate_account_db")
public class AccountRecordTbl implements java.io.Serializable {
	...
	@Column(name = "water_value", precision = 22, scale = 0)
