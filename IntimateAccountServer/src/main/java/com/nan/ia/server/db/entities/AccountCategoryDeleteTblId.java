...
/**
 * AccountCategoryDeleteTblId generated by hbm2java
 */
@Embeddable
public class AccountCategoryDeleteTblId implements java.io.Serializable {

	private int accountBookId;
	private String category;

	public AccountCategoryDeleteTblId() {
	}

	public AccountCategoryDeleteTblId(int accountBookId, String category) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AccountCategoryDeleteTblId))
			return false;
		AccountCategoryDeleteTblId castOther = (AccountCategoryDeleteTblId) other;
